...
- [ ] ECR login successful: `aws ecr getlogin-password --region us-east-1 | docker login --username AWS --password-stdin {account}.dkr.ecr.us-east-1.amazonaws.com`
...
- [ ] GDPR considerations: data residency noted (region: us-east-1)
